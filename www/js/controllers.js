...
//Displaying the contents on the homepage of the user
...
.controller('ProfileCtrl',function($scope,$firebase,$firebaseAuth,$ionicModal
  ,$ionicLoading,$rootScope,$timeout,$state){
